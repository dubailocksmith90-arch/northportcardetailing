        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#00C2FF]/10 border border-[#00C2FF]/30 text-[#00C2FF] text-sm font-medium hover:bg-[#00C2FF]/20 transition-all duration-200 min-h-[44px]"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366] text-sm font-semibold hover:bg-[#25D366]/20 transition-all duration-200 min-h-[44px]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#00C2FF] text-black text-sm font-semibold hover:bg-[#00AADE] transition-all duration-200 min-h-[44px]"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      {menuOpen && (
        <div className="md:hidden bg-[#111114] border-t border-white/5 px-4 py-4">
          ...
          <div className="flex gap-2 mt-1">
            <a
              href={BUSINESS.phone.href}
              className="flex-1 flex items-center justify-center gap-1.5 py-3 rounded-lg bg-white/5 border border-white/10 text-white text-sm font-medium"
            >
              Call
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-[1.5] flex items-center justify-center gap-1.5 py-3 rounded-lg bg-[#25D366] text-white text-sm font-bold"
            >
              WhatsApp Book
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-1.5 py-3 rounded-lg bg-[#00C2FF] text-black text-sm font-bold"
            >
              Directions
            </a>
          </div>
